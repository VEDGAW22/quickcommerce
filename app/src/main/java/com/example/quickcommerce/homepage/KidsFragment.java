...
import com.example.quickcommerce.databinding.FragmentKidsBinding;
...
public class KidsFragment extends Fragment {
    ...
    private void setupTabs() {
        ...
        binding.tabAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                navController.navigate(R.id.action_kidsFragment_to_homeFragment);
            }
        });
        binding.tabMen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_kidsFragment_to_menFragment);;
            }
        });
        binding.tabWomen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_kidsFragment_to_womenFragment);
            }
        });
    }
    private void prepareCategories() {
        ...
        for (int i = 0; i < Constant.allKidsProduct.length; i++) {
            allCategories.add(new Category(Constant.allKidsProduct[i], Constant.allKidsProductsCategoryIcon[i]));
        }
        ...
        adapterCategory = new AdapterCategory(allCategories, new OnCategoryClickListener() {
            ...
            public void onCategoryClick(Category category) {
                ...
                navController.navigate(R.id.action_kidsFragment_to_productFragment, bundle);
            }
        });
        binding.rvcatoKids.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false));
        binding.rvcatoKids.setAdapter(adapterCategory);
    }
    private void setupProfile() {
        ...
        binding.profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_kidsFragment_to_profileFragment2);
            }
        });
    }
    ...
    private void setBanner() {
        ...
        binding.bannerKidsRecyclerView.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false));
        binding.bannerKidsRecyclerView.setAdapter(adapter);

        PagerSnapHelper snapHelper = new PagerSnapHelper();
        snapHelper.attachToRecyclerView(binding.bannerKidsRecyclerView);
        ...
        bannerRunnable = new Runnable() {
            ...
            public void run() {
                if (binding != null) {
                    ...
                    binding.bannerKidsRecyclerView.smoothScrollToPosition(index++);
